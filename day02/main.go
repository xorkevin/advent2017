...
const (
	puzzleInput = `4168	3925	858	2203	440	185	2886	160	1811	4272	4333	2180	174	157	361	1555
...
func lineDivide(line string) int {
	snums := strings.Split(line, "\t")
	...
	fmt.Println("err dividing line:", line)
	return -1
}
